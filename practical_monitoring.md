...
- コンプライアンスを満たすためにも、監視は有用である
- auditdを使うことでLinuxのユーザ関連の監視を簡単に始めることができる。
- ただし、より有益にするためには細かい設定の調整が必要
- HIDSとしてルートキットを完璧に検出することは難しいが、まずはrkhunterを導入すべき

# 11. 監視アセスメントの実行

- フィクションのサービスに対して、本書の内容に基づいて一通りアセスメントしている
