...
- 構造の変更は可逆的
- 振る舞いの変更は非可逆的
- どちらも同じようにコードレビューするのは非効率

### 29. 結合

- １つの要素を変更するのに他の要素の変更が必要となる場合、「結合」しているという
- 結合は、1-Nの関係をもち、カスケーディングによりべき乗で変更コストを増加させる特性を持つ

### 30. コンスタンチンの等価性

- ソフトウェアのコストは、ほぼ変更のコストであり、それはごく一部の大規模な変更に支配されており、大規模な変更は結合によってもたらされる
- すなわち、ソフトウェアのコストを下げるためには、結合を減らさなければならない

### 31. 結合 vs 分離

- 分離に寄って、ある種類の変更の結合を減らせば減らすほど、別の種類の変更に伴う結合が大きくなる
- 結合のコストを払うか、分離のコストを払って利益を享受するか、トレードオフに対する判断が必要である

### 32. 凝集

- 凝集は以下の２つの意味を持つ
  - 結合した要素は、同じ親要素の子要素同士であるべき
  - 結合していない要素は、別の親要素をもつべき
- 凝集度を高めることで、分析／変更しやすくなる
- 凝集度を高めるための再配置は、一度に一つずつ行うべき

### 33. 結論

- 「整頓」は、プログラマ個人が、数分から数時間をかけて、結合を減らし、凝集度を高めるために、構造と振る舞いを分けることを指す

- 先に整頓するか？
  - コスト：コストは小さくなるか？発生する時期が遅くなるか？発生する可能性が低くなるか？
  - 収益：収益は大きくなるか？早くなるか？可能性が高くなるか？
  - 結合：結合は減るか？
  - 凝集：凝集度は高くなるか？
  - あなた：あなたのプログラミングに平穏と満足、喜びをもたらすか？
